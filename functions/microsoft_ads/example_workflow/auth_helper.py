...
from output_helper import (
    output_bing_ads_webfault_error,
...
ALL_TARGET_CAMPAIGN_CRITERION_TYPES = [
    "Age DayTime Device Gender Location LocationIntent Radius"
]
ALL_TARGET_AD_GROUP_CRITERION_TYPES = [
    "Age DayTime Device Gender Location LocationIntent Radius"
]
