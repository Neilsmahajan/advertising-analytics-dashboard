...
import QueryForm from "@/app/spotify-ads/query-form";
    ...
    <div className="min-h-screen bg-[#00BFFF] text-white">
      <div className="container mx-auto px-4 py-32">
        ...
        <div className="flex items-center justify-start mb-6">
          <Image
            src="/spotify-ads-logo.png"
            alt="Spotify Ads Logo"
            width={50}
            height={50}
            className="max-w-full mr-4"
          />
          <h1 className="text-4xl md:text-6xl font-bold">SPOTIFY ADS</h1>
        </div>
        ...
        <section className="mb-12">
          ...
          <p className="text-lg mb-6">
            Follow These Steps To Use This Application With Your Spotify Ads
            Data:
          </p>
