  ...
  return (
    <div className="min-h-screen bg-[#00BFFF] text-white">
      <div className="container mx-auto px-4 py-32">
        {/* Header Section */}
        <h1 className="text-4xl md:text-6xl font-bold mb-6">GOOGLE ANALYTICS</h1>

        {/* Instructions Section */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold mb-4">Instructions</h2>
          <p className="text-lg mb-6">Follow These Steps To Use This Application With Your Google Analytics Data:</p>
          <ol className="space-y-4 list-decimal pl-6">
            <li>Go to your Google Analytics Dashboard.</li>
            <li>
              Navigate to Admin &gt; Account &gt; Account access management
              <ul className="list-disc pl-6 mt-2 space-y-2">
                <li>Add the following email: google-analytics@advertising-analytics-444021.iam.serviceaccount.com</li>
        ...
        <section className="space-y-6 max-w-4xl">
          <div className="space-y-4">
            ...
            <div className="pt-4">
              <Button onClick={handleGetAnalytics} className="bg-[#47adbf] hover:bg-[#47adbf]/90 text-white">
                GET ANALYTICS
              </Button>
            </div>
          </div>
